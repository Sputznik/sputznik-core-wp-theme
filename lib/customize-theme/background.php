<?php
	...
	add_action('customize_register', function( $wp_customize ){
		...
		/** BACKGROUND IMAGE */ 
		$sp_customize->image( $wp_customize, 'sp_bg_section', 'sp_bg[img]', 'Background Image', '');
		
		/** BACKGROUND COLOR */ 
		$sp_customize->color( $wp_customize, 'sp_bg_section', 'sp_bg[color]', 'Background Color', '#ffffff' );
