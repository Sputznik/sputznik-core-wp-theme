<?php
	...
	add_action( 'init', function(){
		...
		// load header4 styles and scripts
		function loadStyle() {
				wp_enqueue_script( 'header4Script', get_template_directory_uri().'/js/app.js',array('bootstrap'), '1.0.9' ,true );

		}

		add_action('loadS','loadStyle' );
