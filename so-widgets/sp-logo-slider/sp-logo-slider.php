<?php
/*
	Widget Name: Sputznik Logo Slider
	...
	Video URI:
*/
class SP_Logo_Slider extends SiteOrigin_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			__('Sputznik Logo Slider', 'siteorigin-widgets'),
			...
			get_template_directory()."/so-widgets/sp-logo-slider"
		);
	}
...
siteorigin_widget_register('sp-logo-slider', __FILE__, 'SP_Logo_Slider');
