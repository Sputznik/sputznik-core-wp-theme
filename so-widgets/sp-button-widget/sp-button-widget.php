...
class SP_Button_Widget extends SiteOrigin_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			__('Sputznik Button', 'siteorigin-widgets'),
			...
			get_template_directory()."/so-widgets/sp-button-widget"
		);
	}

	function get_button_types(){
		return apply_filters( 'sp-sow-button-widget-types', array( 'noclass'	=> 'Default' ) );
	}
...
siteorigin_widget_register('sp-button-widget', __FILE__, 'SP_Button_Widget');
